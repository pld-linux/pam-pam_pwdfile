...
Summary(pl.UTF-8):   Moduł PAM pozwalający na użycie oddzielnych plików z hasłami do różnych usług
Name:		pam-%{modulename}
Version:	0.99
Release:	2
Epoch:		0
...
Moduł PAM pozwalający na użycie oddzielnych plików z hasłami do
różnych usług.
